...
public class AttachGameObjectsToInstantiatedParticles : MonoBehaviour
{
    ...
    void LateUpdate()
    {
        ...
        if (!isPlaying && m_ParticleSystem.isPlaying && !m_ParticleSystem.main.loop) {
            isPlaying = true;
    ...
    {
        yield return new WaitForSeconds(m_ParticleSystem.main.startLifetime.constantMax + m_ParticleSystem.main.duration);
        Destroy(gameObject);
    }
}
